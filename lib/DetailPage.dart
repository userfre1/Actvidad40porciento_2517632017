            ...
            children: [
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Spacer(),
                          Text(widget.mMusic.title, style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 32.0)),
                          SizedBox(
                            height: 6.0,
                          ),
                          Text(
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  SizedBox(width: 32.0),
                  Container(
                    decoration: BoxDecoration(color: iconHoverColor, borderRadius: BorderRadius.circular(50.0)),
                    child: Padding(
